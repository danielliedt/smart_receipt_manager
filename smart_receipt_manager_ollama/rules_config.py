...
# Short names for store identification to prevent them from becoming item names
...
# Mapping keywords to categories for immediate assignment
HARDCODED_RULES = {
...
# Specific overrides for terms that trigger a second look
FALSE_FRIENDS = {
